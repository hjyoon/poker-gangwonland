...
export const COMPUTER_STYLES = [
  {
    key: "balanced",
    label: "기본형",
    description: "패 강도에 따라 콜과 베팅을 균형 있게 선택합니다.",
    foldBelow: 48,
    wagerAbove: 82,
  },
  {
    key: "cautious",
    label: "신중형",
    description: "약한 패를 더 자주 폴드하고 강한 패에서만 베팅이나 레이즈를 선택합니다.",
    foldBelow: 58,
    wagerAbove: 90,
  },
  {
    key: "aggressive",
    label: "공격형",
    description: "더 넓은 패 범위에서 베팅이나 레이즈를 선택합니다.",
    foldBelow: 38,
    wagerAbove: 70,
  },
];
...
export function chooseComputerAction(state, actorIndex = state.currentPlayerIndex) {
  ...
  if (strength < style.foldBelow && toCall > 0) {
    return "fold";
  }
