...
export const MEANINGFUL_E2E_TARGETS = [
  ...
  { id: "multiplayer.tournament-balance-disconnect-rejoin", area: "multiplayer", description: "Balanced multi-table tournament start, table selector, disconnect handling, and participant rejoin." },
